...
DROP TABLE IF EXISTS `nhankhautamtru`;
...
CREATE TABLE `nhankhautamtru` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_NhanKhauTamTru` (`idNhanKhau`),
...
LOCK TABLES `nhankhautamtru` WRITE;
/*!40000 ALTER TABLE `nhankhautamtru` DISABLE KEYS */;
/*!40000 ALTER TABLE `nhankhautamtru` ENABLE KEYS */;
UNLOCK TABLES;
