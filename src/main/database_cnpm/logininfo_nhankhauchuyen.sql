...
--
-- Table structure for table `nhankhauchuyen`
--

DROP TABLE IF EXISTS `nhankhauchuyen`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `nhankhauchuyen` (
  `idNhanKhau` int(11) NOT NULL,
  `ngayChuyen` date NOT NULL,
  `noiChuyenDen` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `nhankhauchuyen`
--

LOCK TABLES `nhankhauchuyen` WRITE;
/*!40000 ALTER TABLE `nhankhauchuyen` DISABLE KEYS */;
/*!40000 ALTER TABLE `nhankhauchuyen` ENABLE KEYS */;
UNLOCK TABLES;
