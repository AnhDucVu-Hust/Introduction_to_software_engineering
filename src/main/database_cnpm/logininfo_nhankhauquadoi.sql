...
--
-- Table structure for table `nhankhauquadoi`
--

DROP TABLE IF EXISTS `nhankhauquadoi`;
...
CREATE TABLE `nhankhauquadoi` (
  ...
  KEY `FK_NguoiKhaiNhanKhauQuaDoi` (`idNguoiKhai`),
...
--
-- Dumping data for table `nhankhauquadoi`
--

LOCK TABLES `nhankhauquadoi` WRITE;
/*!40000 ALTER TABLE `nhankhauquadoi` DISABLE KEYS */;
/*!40000 ALTER TABLE `nhankhauquadoi` ENABLE KEYS */;
UNLOCK TABLES;
